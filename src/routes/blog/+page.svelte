...
<section>
  <div class="bg-primary-950 p-8 shadow-md min-w-full  font-secondary mb-0">
    ...
    <div class="text-primary-200 mb-8">
      ...
      <p class="mb-4">Sólo un dato: <span class="bg-gradient-to-r from-primary-300 to-primary-800 bg-clip-text text-transparent">el 10% más rico controla el <strong>76%</strong> de la riqueza total del mundo mientras que el <strong>50%</strong> más pobre controla el <strong>2%</strong>.</span><sup><a href="#ref1" id="cite1" class="text-primary-700 hover:text-primary-300">1</a></sup></p>  
