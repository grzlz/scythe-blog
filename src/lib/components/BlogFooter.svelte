...
<footer class="bg-primary-100 font-secondary">
    ...
    <div class="prose text-primary-700">
      ...
      <p class="text-sm">Somos desarrolladores, diseñadores y pensadores. <br />Estamos construyendo <span class="font-bold text-red-500 font-troll">Scythe</span>, un protocolo que mejora la coordinación entre la economía y el gobierno de un sistema.</p>
    </div>
    <div>
        <h2 class="text-xl font-semibold mb-2 text-primary-900">Trade offer:</h2>
        <p class="text-sm mb-6 text-primary-700">Si nos das tu correo, te damos acceso a toda nuestra tecnología.</p>
