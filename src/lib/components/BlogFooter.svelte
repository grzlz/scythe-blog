...
<footer class="bg-primary-100 font-primary">
    ...
    <div class="prose">
      ...
      <p class="text-sm leading-relaxed text-primary-300">Somos desarrolladores, diseñadores y pensadores con la misión de democratizar el acceso a la producción de software. Estamos empezando, vamos una industria a la vez.</p>
